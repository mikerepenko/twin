...
const { catchErrors, generateCode } = require('../utils.js')

module.exports = function(app) {
  app.post('/login', catchErrors(async (req, res) => {
  ...
  app.post('/register', catchErrors(async (req, res) => {
  ...
  app.post('/code', catchErrors(async (req, res) => {
    const response = JSON.parse(Object.keys(req.body)[0])
